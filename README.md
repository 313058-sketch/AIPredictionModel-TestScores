...
could a computer predict how to get a higher test score using a set of numbers of hours slept and hours studied? in this project I created a data set of multiple rows of numbers as examples of test scores and hours they had slept and studied for.

# python-portfolio
My Python programs

Built a _data set_________ that __achieves 82 or more accuracy________ using ___thonny _______, resulting in __a AI prediction score________.

## Problem
the problem is i need to create a data set that includes a row of numbers of hours slept and hours studided to input the AI on
...
## Learning
One important thing learned was the ability to solve a higher level of coding and being able to collect and create good data for accurate results.
